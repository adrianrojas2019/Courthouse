 ...
 * */
    public void contractorMidlandMapsUnassign(String environment,String superUserName, String superUserPassword, String contractorUserName, String contractorPassword,String myCompanyName, String countyMidlandMaps) throws InterruptedException {
        ...
        //Add on Assigned counties search text box: CountyMidland Map
        newUserAdminPage.removeMidlandMapsCounty(countyMidlandMaps);
        newUserAdminPage.clickOnAssignedCountyMidlandMaps(countyMidlandMaps);
        Assert.assertTrue(newUserAdminPage.isAssignedCountyDisplayed(countyMidlandMaps), "Cannot find Assigned County: " + countyMidlandMaps);

        //Proceed to assign the county
        newUserAdminPage.clickOnArrowLeft();
        Assert.assertTrue(newUserAdminPage.isCountyUnassigned(countyMidlandMaps), "County has not been Unassigned.");
