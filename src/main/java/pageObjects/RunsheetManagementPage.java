...
public class RunsheetManagementPage extends PageObjects {
    ...
    private final By RUNSHEET_MANAGEMENT_GRID = By.xpath("//section[@class='row runsheet-section-container ng-scope']");
    private final By REQUEST_COPY_ACTIONS = By.xpath("//h4[text()='Request Copy Actions']");
    private final By STATUS_COMBO = By.xpath("//select[@class='form-control ng-pristine ng-untouched ng-valid']");
    ...
    private final By SAVE_BUTTON = By.xpath("//button[@class='btn btn-success']");
    private final By DENY_BUTTON_ENABLED = By.xpath("//label[@class='btn btn-default ng-untouched ng-valid ng-binding active ng-dirty ng-valid-parse']");
    private final By APPROVE_BUTTON_ENABLED = By.xpath("//label[@class='btn btn-default ng-untouched ng-valid ng-binding active ng-dirty ng-valid-parse']");
