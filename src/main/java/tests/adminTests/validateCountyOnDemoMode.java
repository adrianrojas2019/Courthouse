...
public class validateCountyOnDemoMode extends SeleniumInitializer {
    @Parameters({"environment","usernameToLogIn","passwordToLogIn","companyAcct","companyID","countyOnDemoMode","contractorUserName","contractorPassword"})
    @Test(groups = {"CH_Admin_County_On_Demo_Mode", "Regression"})

    public void validateCountyOnDemoMode(String environment, String usernameToLogIn, String passwordToLogIn, String companyAcct, String companyID, String countyOnDemoMode, String contractorUserName, String contractorPassword) throws InterruptedException {
        ...
        ValidateCountyOnDemoMode(newCHMainPage.LoginMenu(),environment,companyAcct,companyID,countyOnDemoMode,contractorUserName,contractorPassword);
    }

    public void ValidateCountyOnDemoMode(UserAdministrationPage newAdministrationPage, String environment, String companyAcct, String companyID,String countyOnDemoMode, String contractorUserName, String contractorPassword){
        ...
        newAdministrationPage.addNewExpirationDate((String.format("%02d",cal.get(Calendar.MONTH)+1)) + "." + String.format("%02d",cal.get(Calendar.DAY_OF_MONTH)+2) + "." + cal.get(Calendar.YEAR));
