...
public class contractorRunsheetSharingNewRequestCopy extends SeleniumInitializer {
    ...
    @Test(groups = "CH_Contractor_Request_Runsheet_New_Request_Copy")
    ...
    public void contractorRunsheetSharingNewRequestCopy(String environment,String superUserName, String superUserPassword, String contractorUserName, String contractorPassword,String contractorName, String myCompanyRunsheetName) throws InterruptedException {
        ...
        newExplorerPage.clickOnRunsheetNameField(myCompanyRunsheetName+(now.get(Calendar.MONTH)+1) + " " + (now.get(Calendar.DAY_OF_MONTH) + " " + now.get(Calendar.YEAR))+"(1)");
        ...
        Assert.assertTrue(newExplorerPage.isRequestCopyMessageDisplayed(myCompanyRunsheetName+(now.get(Calendar.MONTH)+1) + " " + (now.get(Calendar.DAY_OF_MONTH) + " " + now.get(Calendar.YEAR))+"(1)"),"Request Copy Runsheet Success Message has not been displayed. (Request Copy)");
    }
